...
app.post("/api/analyze", upload.single("image"), async (req, res) => {
  try {
    ...
    const vehicle = await analyzeWithGemini(req.file);
...
<label class="drop" for="file">📸<br><strong>Ajoute une capture ou une photo de l’annonce</strong><br><span class="small">JPG, PNG, WEBP — 12 Mo</span></label>
